...
if consumed_units <= 100:
    ...
    if consumed_units <= 200:
        ...
        cost_of_usage = 300*4.50 + 100*6.00 + (consumed_units - 500) * 8.00
    elif consumed_units <= 800:
        cost_of_usage = 300*4.50 + 100*6.00 + 200*8.00 + (consumed_units - 600) * 9.00
    elif consumed_units <= 1000:
        cost_of_usage = 300*4.50 + 100*6.00 + 200*8.00 + 200*9.00 + (consumed_units - 800) * 10.00
    else:
        cost_of_usage = 300*4.50 + 100*6.00 + 200*8.00 + 200*9.00 + 200*10 + (consumed_units - 200) * 11.00
